...
namespace SMS.Controllers
{
    public class StudentsController : Controller
    {
        ...
        {
            string url = "https://localhost:7264/api/Students/AddStudent";
        ...
        {
            string url = $"https://localhost:7264/api/Students/GetStudent/{id}";
            HttpResponseMessage response = client.GetAsync(url).Result;
        ...
        {
            string url = "https://localhost:7264/api/Students/UpdateStudent";
            var jsonData = JsonConvert.SerializeObject(student);
            var content = new StringContent(jsonData, System.Text.Encoding.UTF8, "application/json");
        ...
        {
            string url = $"https://localhost:7264/api/Students/DeleteStudent/{id}";
        ...
        {
            string url = "https://localhost:7264/api/Students/GetAllPerformances";
            HttpResponseMessage response = client.GetAsync(url).Result;
        ...
        {
            string url = $"https://localhost:7264/api/Students/GetPerformance/{id}";
            HttpResponseMessage response = client.GetAsync(url).Result;
        ...
        {
            string url = "https://localhost:7264/api/Students/AddPerformance";
        ...
        public IActionResult GetTeacher()
        {
            ...
            string url = "https://localhost:7264/api/Students/GetTeacher";
        ...
        public IActionResult GetClass()
        {
            ...
            string url = "https://localhost:7264/api/Students/GetClass";
            HttpResponseMessage response = client.GetAsync(url).Result;
            if (response.IsSuccessStatusCode)
            {
                var jsondata = response.Content.ReadAsStringAsync().Result;
