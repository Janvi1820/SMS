...
namespace SMS.Controllers
{
    public class AcademicController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            string url = "https://localhost:7264/api/Academic/GetAllCurricula";
        ...
        {
            string url = "https://localhost:7264/api/Academic/AddCurriculum";
        ...
        {
            string url = "https://localhost:7264/api/Academic/AddTimeTable";
        ...
        public IActionResult GetTimeTable()
        {
            ...
            string url = "https://localhost:7264/api/Academic/GetTimeTable";
            HttpResponseMessage response = client.GetAsync(url).Result;
            if (response.IsSuccessStatusCode)
            {
                var jsondata = response.Content.ReadAsStringAsync().Result;
        ...
        {
            string url = "https://localhost:7264/api/Academic/AddSub";
        ...
        public IActionResult FetchSubjects()
        {
            ...
            string url = "https://localhost:7264/api/Academic/GetSub";
            HttpResponseMessage response = client.GetAsync(url).Result;
            if (response.IsSuccessStatusCode)
            {
                var jsondata = response.Content.ReadAsStringAsync().Result;
